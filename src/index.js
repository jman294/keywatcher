...
export function watchKeys(inputEl, keyPress, onDelete) {
...
// Watch for keyUp events on an element
// Params:
// inputEl: the element to listen on
// keyUp: a callback for keyup
export function watchKeyup(inputEl, keyUp) {
  inputEl.addEventListener('keyup', function onKeyUp(e) {
    keyUp(e)
  })
}
